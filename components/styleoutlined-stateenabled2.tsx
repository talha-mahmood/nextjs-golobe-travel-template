...
type StyleoutlinedStateenabled2Type = {
  input?: string;
  label?: string;
  chevronDown?: string;
...
const StyleoutlinedStateenabled2: NextPage<StyleoutlinedStateenabled2Type> = ({
  input = "Input",
  label = "Label",
  chevronDown,
  ...
  const styleoutlinedStateenabled2Style: CSSProperties = useMemo(() => {
    return {
  ...
  return (
    <div
      ...
      style={styleoutlinedStateenabled2Style}
    >
      <div className="self-stretch rounded bg-neutrals flex flex-col items-start justify-start border-[1px] border-solid border-gray-200">
        <div className="self-stretch rounded-t rounded-b-none flex flex-row py-1 pr-0 pl-4 items-center justify-start">
          <div className="flex-1 h-10 flex flex-col items-start justify-center relative">
            ...
            <div className="my-0 mx-[!important] absolute top-[-16px] left-[-4px] bg-neutrals flex flex-row py-0 px-1 items-center justify-start z-[1] text-sm text-blackish-green">
              <div className="relative">{label}</div>
            </div>
          </div>
          <div className="w-12 h-12 flex flex-col p-3 box-border items-center justify-center">
            <img
...
export default StyleoutlinedStateenabled2;
