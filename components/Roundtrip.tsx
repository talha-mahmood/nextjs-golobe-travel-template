...
const RoundTrip = () => {
  ...
  const [endDate2, setEndDate2] = useState(fourDaysLater);
  ...
  const handleSelect2 = (ranges: any) => {
    setStartDate(ranges.selection.startDate2);
    setEndDate(ranges.selection.endDate2);
  };
